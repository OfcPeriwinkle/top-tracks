...
def create_spotify_playlist(
    ...
    res = sp.user_playlist_create(
        user=user['id'],
        name=f'Top {f"{display_genres[0]} " if display_genres else "Tracks "}{"& More " if len(display_genres) > 1 else " "}from {display_year}',
        public=False,
        description=f'The top {genre_description} singles of {display_year} according to Rate Your Music; '
