...
def create_spotify_playlist(
    ...
    res = sp.user_playlist_create(
        user=user['id'],
        name=f'Top {display_genres[0]} {"& More" if len(display_genres) > 1 else ""} Tracks of {display_year}',
        public=False,
        description=f'The top {genre_description} singles of {display_year} according to Rate Your Music; generated by https://github.com/OfcPeriwinkle/top-tracks')
